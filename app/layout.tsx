...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${chaneyReg.variable} ${chaneyWide.variable} ${chaneyUltraExt.variable} antialiased`}
      >

        <header className="text-center mt-10">
          <h1 className="text-5xl text-balance sm:text-[8.5vw] leading-none uppercase tracking-tight ~mb-4/6 sm:px-0">What's new in CSS?</h1>
