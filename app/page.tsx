...
export default function Home() {
  return (
    <>
      ...
      <Slide id="slide1" boxClasses="flex">
      ...
      <Slide id="slide3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="~p-2/8 border border-black content-center w-full md:w-auto text-center">
            <p className="font-primary ~text-base/xl font-normal leading-none">100+ more</p>
          </div>
        </div>
      ...
      <Slide id="slide5" boxClasses="flex flex-col gap-8">
      ...
      <Slide id="slide6" boxClasses="flex flex-col lg:flex-row justify-center items-start ~gap-8/20">
        <Image
          src={cssLogo}
