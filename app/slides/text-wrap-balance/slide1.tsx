  ...
  content: (
    <>
      <div className="flex flex-col gap-5 lg:w-7/12 mx-auto">
        ...
        <p>Possibly my most used new feature. This eliminates the need to put max-widths on your headlines, or insert br / span tags to control how the text wraps.</p>
